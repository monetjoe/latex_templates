...
\renewcommand\@maketitle{%
	...
	\begin{minipage}{0.95\textwidth}
		...
		{\centering \bfseries \zihao{3} \@title \par} %\thanks{\weizhu{Corresponding Author (1900--), Shenyang Xu, Academic Degree, Academic Title, E-mail}} \par } %For those are not funded by a specific grant
		\vskip 3em
