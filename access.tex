...
$\hskip-7pt$\includegraphics[scale=0.52]{./figs/equation3.png}
...
\Figure[t!](topskip=0pt, botskip=0pt, midskip=0pt){./figs/fig1.png}
...
\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{./figs/author1.png}}]{First A. Author} received the B.S. and M.S. degrees in aerospace engineering from
...
\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{./figs/author2.png}}]{Second B. Author} (M'76--SM'81--F'87) and all authors may include
