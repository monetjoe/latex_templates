...
See \cite{IEEEexample:article_typical} for resources on formatting math into text and additional help in working with \LaTeX .
...
This will display as: see \cite{IEEEexample:conf_typical}.

For multiple citations code as follows: {\tt{$\backslash$cite\{ref1,ref2,ref3\}}}
which will produce \cite{IEEEexample:book_typical}. For reference ranges that are not consecutive code as {\tt{$\backslash$cite\{ref1,ref2,ref3,ref9\}}} which will produce  \cite{IEEEexample:articlelargepages}
...
\begin{figure}[!t]
  \centering
  \includegraphics[width=2.5in]{figs/fig1.png}
...
\begin{figure*}[!t]
  \centering
  \subfloat[]{\includegraphics[width=2.5in]{figs/fig1.png}%
...
IEEE aims to provide authors with the proper guidance on mathematical typesetting style and assist them in writing the best possible article. As such, IEEE has assembled a set of examples of good and bad mathematical typesetting \cite{IEEEexample:articledualmonths}.
